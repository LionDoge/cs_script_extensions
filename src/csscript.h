...
public:
	...
	CUtlVector< CGlobalSymbol > registeredTypes; // 0x40 (64);  // NOLINT(clang-diagnostic-padded)
	CUtlHashtable< CGlobalSymbol, v8::Global<v8::FunctionTemplate>*, GlobalSymbolHashFunctor, PointerEqualFunctor > functionTemplateMap; // 0x50 (80);
	CUtlHashtable< CGlobalSymbol, v8::Global<v8::Object>*, GlobalSymbolHashFunctor, PointerEqualFunctor > enumMap; // 0x70 (112);
	CUtlHashtable< CGlobalSymbol, v8::Global<v8::Function>*, GlobalSymbolHashFunctor, PointerEqualFunctor > callbackMap; // 0x90 (144);
};
